...
class PAGER:
    ...
    # 2.source: a list of sources refered to 'https://discovery.informatics.uab.edu/PAGER/index.php/pages/help'
    ...
    def run_pager(self, genes, **kwargs):
        ...
        response = requests.post(
            "https://discovery.informatics.uab.edu/PAGER/index.php/geneset/pagerapi",
            data=params,
        )
    ...
    def pathMember(self, PAG_IDs):
        ...
        # Work around PAGER API form encode issue.
        response = requests.post(
            "https://discovery.informatics.uab.edu/PAGER/index.php/geneset/get_members_by_ids/",
            data=params,
        )
        # print(response.request.body)
    ...
    def pathInt(self, PAG_IDs):
        ...
        # Work around PAGER API form encode issue.
        response = requests.post(
            "https://discovery.informatics.uab.edu/PAGER/index.php/pag_pag/inter_network_int_api/",
            data=params,
        )
        # print(response.request.body)
        return pd.DataFrame(response.json()["data"])
    ...
    def pathReg(self, PAG_IDs):
        ...
        # Work around PAGER API form encode issue.
        response = requests.post(
            "https://discovery.informatics.uab.edu/PAGER/index.php/pag_pag/inter_network_reg_api/",
            data=params,
        )
        # print(response.request.body)
        return pd.DataFrame(response.json()["data"])
    ...
    def pagRankedGene(self, PAGid):
        response = requests.get(
            "https://discovery.informatics.uab.edu/PAGER/index.php/genesinPAG/viewgenes/"
            + PAGid
        )
    ...
    def pagGeneInt(self, PAGid):
        response = requests.get(
            "https://discovery.informatics.uab.edu/PAGER/index.php/pag_mol_mol_map/interactions/"
            + PAGid
        )
        return pd.DataFrame(response.json()["data"])
    ...
    def pagGeneReg(self, PAGid):
        response = requests.get(
            "https://discovery.informatics.uab.edu/PAGER/index.php/pag_mol_mol_map/regulations/"
            + PAGid
        )
        return pd.DataFrame(response.json()["data"])
    ...
    def path_NGSEA(SELF, genes, PAGmember):
        ...
        for rowIdx in range(0, PAGmember.shape[0]):
            PAGsetsStr = (
                PAGsetsStr
                + PAGmember.iloc[rowIdx, 0]
                + "\\t\\t"
                + PAGmember.iloc[rowIdx, 1]
                + "\\t\\t\\t"
            )
        params = {}
        ...
        response = requests.post(
            "https://discovery.informatics.uab.edu/PAGER/index.php/geneset/ngseaapi/",
            data=params,
        )
        # print(response.request.body)
        return pd.DataFrame(response.json()["data"])
