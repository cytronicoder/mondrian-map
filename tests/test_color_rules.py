...
class TestColorClassification:
    ...
    def test_not_significant_yellow(self):
        ...
        colors = get_colors(df)
        assert colors[0] == "yellow" or "ffcc" in colors[0].lower() or "ff0" in colors[0].lower()
    ...
    def test_mixed_gray(self):
        ...
        assert colors[0] == "gray" or colors[0] == "white" or "ccc" in colors[0].lower() or "808" in colors[0].lower()
    ...
    def test_boundary_pfdr(self):
        ...
        assert colors[0] in ["red", "blue", "yellow", "gray", "white"] or colors[0].startswith("#")
...
class TestEdgeCases:
    ...
    def test_extreme_wfc_values(self):
        ...
        assert len(colors) == 2
        for color in colors:
            assert color in ["red", "blue", "yellow", "gray", "white"] or color.startswith("#")
